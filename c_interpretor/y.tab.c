...
static const yytype_int8 yyrhs[] =
{
      17,     0,    -1,    18,    -1,    19,    -1,    18,    19,    -1,
       3,    -1,     6,     4,     3,    -1,     7,     9,     5,     9,
       3,    -1,     8,     9,     5,     6,     3,    -1,    20,     9,
       9,     3,    -1,    20,     9,    10,     3,    -1,    20,     9,
      11,     3,    -1,    14,     9,     9,     3,    -1,    13,    -1,
      15,    -1
};
...
static const char *const yytname[] =
{
  ...
  "program", "command_list", "command", "directive", 0
};
#endif
  ...
  switch (yyn)
    {
        case 6:
#line 52 "interp.y"
    { put_symbol((yyvsp[(1) - (3)]),pc);}
    break;

  case 7:
#line 54 "interp.y"
    { gen_code((yyvsp[(1) - (5)]),(yyvsp[(2) - (5)]),(yyvsp[(4) - (5)]));}
    break;
...
#line 56 "interp.y"
  ...
  case 9:
#line 58 "interp.y"
    { put_data((yyvsp[(2) - (4)]),1,(yyvsp[(3) - (4)]));}
    break;

  case 10:
#line 60 "interp.y"
    { put_data((yyvsp[(2) - (4)]),2,(yyvsp[(3) - (4)]));}
    break;

  case 11:
#line 62 "interp.y"
    { put_data((yyvsp[(2) - (4)]),3,(yyvsp[(3) - (4)]));}
    break;

  case 12:
#line 64 "interp.y"
    { put_data((yyvsp[(2) - (4)]),4,(yyvsp[(3) - (4)]));}
    break;
...
void assem2()
{
	...
	for (i=0; i<pc; i++) {
		if (is_inst2(code[i].f)){
			j=search_symbol(code[i].a);
			if (j==0)
				semantic_error(1,code[i].a);
			else 
				code[i].a=symbol[j].addr;}
	}
}

void gen_code(OPCODE op, int l, int a)
{
	if (pc>=CODE_MAX) 
		semantic_error(10);
	else {
...
void semantic_error(int i, char *s)
{
	switch (i) {
